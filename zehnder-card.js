      ...
      <div class="bg">
          <div class="flex-container">
              ...
              <div class="flex-col-main">
                  ...
                  <div title="Filter age" style="font-size: small; padding: 20px"><ha-icon icon="mdi:clock-time-eight"/>${(this.hass.states[`sensor.${this.device_name}_filter_hours`].state / 720).toFixed(1)}months</div>
              </div>
